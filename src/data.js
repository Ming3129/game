...
export const RARITIES = {
  common:    { key: 'common',    name: '普通', color: '#9AA3B2', restock: 5, bonus: 0,  unitPrice: 1   },
  rare:      { key: 'rare',      name: '稀有', color: '#7DE2D1', restock: 3, bonus: 12, unitPrice: 5  },
  epic:      { key: 'epic',      name: '史诗', color: '#C77DFF', restock: 2, bonus: 30, unitPrice: 15  },
  legendary: { key: 'legendary', name: '传说', color: '#FFD98E', restock: 1, bonus: 80, unitPrice: 20 },
...
export const BOXES = {
  S:   { key: 'S',   name: 'S 盲盒',   price: 10,  desc: '1 普通 + 1 稀有', slots: [ { rarity: 'common', n: 1 }, { rarity: 'rare', n: 1 } ] },
  SS:  { key: 'SS',  name: 'SS 盲盒',  price: 15, desc: '1 普通 + 2 稀有 + 1 惊喜', slots: [ { rarity: 'common', n: 1 }, { rarity: 'rare', n: 2 }, { rarity: 'wild', n: 1, odds: [ ['rare', 0.9], ['epic', 0.1] ] } ] },
  SSS: { key: 'SSS', name: 'SSS 盲盒', price: 20, desc: '1 普通 + 3 稀有 + 1 史诗 + 1 大惊喜', slots: [ { rarity: 'common', n: 1 }, { rarity: 'rare', n: 3 }, { rarity: 'epic', n: 1 }, { rarity: 'wild', n: 1, odds: [ ['epic', 0.7], ['legendary', 0.3] ] } ] },
}
...
export const COINS = {
  red:    { key: 'red',    name: '红', hex: '#FF5A5A', pair: '本单收入 +10%' },
  gold:   { key: 'gold',   name: '金', hex: '#FFD98E', pair: '粉丝 +5' },
